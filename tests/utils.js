...
test('warns with branded message', () => {
  ...
  expect(console.warn).toBeCalledWith('[ree-validate] Something is not right');
});
...
test('creates branded errors', () => {
  ...
  }).toThrowError('[ree-validate] My Error');
});
...
test('checks if ree-validate is available globally.', () => {
