import { pluginInstance as ReeValidate } from '../plugin';
...
export default class Resolver {
  static generate (el, binding, vnode) {
    ...
    const options = ReeValidate.resolveConfig(vnode.context);
  ...
  static resolveEvents (el, vnode) {
    ...
    if (!events && ReeValidate.config.events) {
      events = ReeValidate.config.events;
    }
